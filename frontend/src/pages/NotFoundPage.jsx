...
export default function NotFoundPage() {
  ...
  return (
    <div ref={pageRef} className="w-full bg-[#fcf9f4] min-h-[70vh] flex items-center justify-center py-12 lg:py-16 px-4 relative overflow-hidden">
      {/* Ambient glow orbs */}
      ...
      <div ref={contentRef} className="max-w-lg w-full text-center space-y-5 lg:space-y-6 bg-white rounded-3xl p-6 sm:p-8 lg:p-12 border border-[#e5e2dd] shadow-sm relative">
        ...
        <div className="w-14 h-14 lg:w-16 lg:h-16 rounded-full bg-[#f6f3ee] text-[#964735] mx-auto flex items-center justify-center">
        ...
        <div className="space-y-2">
          ...
          <h1 className="font-serif text-[28px] sm:text-[32px] lg:text-[40px] text-[#180f0a] font-normal leading-tight">
        ...
        <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-3">
          ...
          <Link
            to="/shop"
            data-404-cta
            className="w-full sm:w-auto px-6 py-3 rounded-full bg-[#f6f3ee] text-[#180f0a] hover:bg-[#e5e2dd] transition-all duration-300 hover:-translate-y-0.5 text-[13px] font-semibold flex items-center justify-center gap-2 border border-[#e5e2dd]"
          >
        ...
        <div className="pt-4 border-t border-[#e5e2dd] space-y-3">
          <p className="text-[11px] lg:text-[12px] text-[#80756f] font-semibold uppercase tracking-wider">Or explore</p>
          <div className="flex flex-wrap items-center justify-center gap-2 lg:gap-3">
            ...
            <Link
              to="/collections"
              data-404-cta
              className="inline-flex items-center gap-1.5 px-3.5 lg:px-4 py-2 rounded-full bg-[#f6f3ee] text-[11px] lg:text-[12px] font-semibold text-[#4e4540] hover:bg-[#ebe8e3] transition-colors"
            >
              Collections
            </Link>
          </div>
