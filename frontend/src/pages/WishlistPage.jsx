        ...
        {wishlist.length === 0 && wishlistUnavailable.length === 0 ? (
          !isAuthed ? (
            ...
            <div className="relative bg-white rounded-3xl p-12 lg:p-16 text-center border border-[#e5e2dd] max-w-xl mx-auto space-y-4 overflow-hidden">
              ...
              <div className="relative w-16 h-16 rounded-full bg-[#f6f3ee] mx-auto flex items-center justify-center">
                <Heart className="w-7 h-7 text-[#964735]" />
              </div>
              <h2 className="relative font-serif text-[26px] text-[#180f0a]">Sign in to save your favorite creations.</h2>
              ...
              <div className="relative pt-2 flex flex-col sm:flex-row items-center justify-center gap-3">
                ...
                <Link
                  to="/shop"
                  className="inline-flex items-center gap-2 px-7 py-3 rounded-full border border-[#e5e2dd] text-[#180f0a] hover:bg-[#f6f3ee] transition-all duration-300 text-[13px] font-semibold hover:shadow-sm hover:-translate-y-0.5 active:translate-y-0"
                >
            ...
            <div className="relative bg-white rounded-3xl p-12 lg:p-16 text-center border border-[#e5e2dd] max-w-xl mx-auto space-y-4 overflow-hidden">
              ...
              <div className="relative w-16 h-16 rounded-full bg-[#f6f3ee] mx-auto flex items-center justify-center text-3xl">
                🤍
              </div>
              <h2 className="relative font-serif text-[26px] text-[#180f0a]">No keepsakes saved yet</h2>
              <p className="relative text-[14px] text-[#4e4540]">
          ...
          <div ref={gridRef} className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-6">
            {wishlist.map((item) => (
              <div
                key={item.id}
                data-wishlist-card
                className="bg-white rounded-3xl p-4 border border-[#e5e2dd] shadow-xs flex flex-col justify-between space-y-4 group hover:shadow-md transition-shadow duration-300"
              >
                  ...
                  {wishlistUnavailable.map((id) => (
                    ...
                    >
                      ...
                      <button
                        ...
                        className="px-4 py-2 rounded-full border border-[#e5e2dd] text-[#80756f] hover:text-[#180f0a] text-[12px] font-semibold flex items-center gap-1.5 transition-all duration-300 hover:shadow-sm"
                      >
